...
$title = "Tambah User - SMAN 21 BANDUNG";
...
if ($msg == 'oversize') {
    $alert = '<div class="alert alert-warning alert-dismissible fade show" role="alert">
  <i class="fa-solid fa-xmark"></i> Tambah user gagal, maximal ukuran gambar adalah 1mb
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
}
if ($msg = 'added') {
...
<div id="layoutSidenav_content">
  ...
  <div class="card-header">
    ...
    <button type="reset" name="reset" class="btn btn-danger float-end me-1"></i><i class="fa-solid fa-xmark"></i> reset</button>
  </div>
  <div class="card-body">
   <div class="row"></div>
     <div class="col-8">
    ...
    <div class="col-sm-9" style="margin-left: -50-px;">
      <input type="text" class="form-control border-0 border-bottom" pattern="[A-Za-z0-9]{3,}"title="minimal 3 karakter" id="username" name="username" maxlength="20" required>
    </div>
  </div>
  <div class="mb-3 row">
